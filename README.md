...
We utilize veRL to conduct training. The relevant code is located in `src/third_party/verl`:
...
#### ⚙️ PPO Training Configuration

The PPO training implementation is detailed in:
